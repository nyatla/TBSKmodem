...
from tbskmodem.kokolink.types import Iterable, Iterator
from tbskmodem.kokolink.utils.recoverable import  RecoverableException, RecoverableStopIteration
from tbskmodem.kokolink.utils import AsyncMethod
from tbskmodem.kokolink.interfaces import IBitStream, IRoStream,IRecoverableIterator
from tbskmodem.kokolink.streams.rostreams import BasicRoStream
from tbskmodem.kokolink.streams import BitStream,RoStream

from tbskmodem.kokolink.protocol.tbsk.toneblock import TraitTone
from tbskmodem.kokolink.protocol.tbsk.preamble import Preamble
...
from tbskmodem.kokolink.protocol.tbsk.traitblockcoder import TraitBlockEncoder,TraitBlockDecoder
...
class TbskDemodulator_impl:
    ...
    def __init__(self,tone:TraitTone,preamble:Preamble=None):
        ...
        self._pa_detector=preamble if preamble is not None else CoffPreamble(tone)
